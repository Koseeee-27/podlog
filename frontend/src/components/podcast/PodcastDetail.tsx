  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6">
      {podcast.artwork_url ? (
        ...
        <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-xl bg-gray-100 flex items-center justify-center flex-shrink-0 mx-auto sm:mx-0">
      ...
      <div className="flex-1 min-w-0">
        ...
        {podcast.genre && (
          <span className="inline-block mt-2 px-3 py-1 text-sm bg-indigo-50 text-indigo-700 rounded-full">
            {podcast.genre}
          </span>
        )}
        {podcast.description && (
