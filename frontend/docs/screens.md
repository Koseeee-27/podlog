...
flowchart TD
    ...
    %% トップページからの遷移
    HOME -- "「Google で始める」押下（未ログイン時）" --> LOGIN
...
| 要素     | SP          | PC               |
| ------ | ----------- | ---------------- |
| アクセス方法 | ボトムナビ→ユーザーページ→設定 or ドロップダウン | ヘッダーのドロップダウンから遷移 |
| レイアウト  | 全幅          | カード型で中央配置        |
