...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/usecase.CreatePodcastInput"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/usecase.PodcastSearchResult"
                        }
                    }
                }
            }
        ...
        "/podcasts/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "親カテゴリ名（ジャンル一覧 API の id を指定。サブカテゴリに自動展開される）",
                        "name": "genre",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "usecase.PodcastSearchResult": {
            "type": "object",
            "properties": {
                "podcasts": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/usecase.PodcastSearchItem"
                    }
                },
                "total": {
                    "type": "integer"
